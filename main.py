...
def play():
    while True:
        ...
        fg = pygame.transform.scale(pygame.image.load("assets\images\stages\stardustFloor.png").convert_alpha(), (SCREEN_WIDTH, SCREEN_HEIGHT + 200))
        ...
        while running:
            ...
            for i in range(0, tiles):
                screen.blit(fg, (i * bg_width + floorSpeed - bg_width, -255))
